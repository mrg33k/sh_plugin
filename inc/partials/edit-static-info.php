		...
		<div class="edit-form">
			<form action="invite.php" method="POST">
				<fieldset>
					...
					<input type="text" name="fname" value="<? echo $u_first_name ?>"/>
					</div>
					
					<div class="col-md-3">					
					<!-- Last Name -->
					<label>Last Name</label>
					<input type="text" name="lname" value="<? echo $u_last_name ?>"/>
					</div>
					...
					<div class="col-md-3">
						<label>Email</label>
						<input type="text" name="email" value="<? echo $u_email ?>" />
					</div>
					<!-- City -->
					<div class="col-md-3">					
					<label>City</label>
					<input type="text" name="city" value="<? if(is_numeric($u_location)){echo '';}else{ echo $u_location; } ?>"/>
					</div>
					...
					<input type="text" name="zipcode" value="<? if(is_numeric($u_location)){echo $u_location;}else{ echo ''; } ?>"/>
					</div>
